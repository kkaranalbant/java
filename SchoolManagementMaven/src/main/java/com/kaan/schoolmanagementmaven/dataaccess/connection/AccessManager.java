...
public class AccessManager implements IAccessManager{
    ...
    public AccessManager (String hostName , int port , String dbName , String userName , String pass) throws SQLException{
    ...
    @Override
    public void changeDatabaseValues() throws SQLException {       
        access.setDbName(dbName);
